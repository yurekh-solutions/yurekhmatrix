      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        {features.map((feature, index) => {
          ...
          return (
            <div
              key={index}
              className={`grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center mb-12 md:mb-16 lg:mb-20 ${
            ...
            >
              ...
              <div className={`${feature.reverse ? "lg:col-start-2" : ""} space-y-4 md:space-y-6`}>
                ...
                <Button 
                  size="lg"
                  className="bg-gradient-to-r from-primary to-secondary text-primary-foreground px-6 md:px-8 py-5 md:py-6 text-sm md:text-base rounded-full shadow-elegant mt-2 md:mt-4"
                >
                  {feature.buttonText}
              ...
              <div className={`${feature.reverse ? "lg:col-start-1 lg:row-start-1" : ""} relative group`}>
                {/* Glass container */}
                <div className="relative bg-gradient-to-br from-primary/5 via-background/50 to-secondary/5 backdrop-blur-sm border border-white/20 dark:border-white/10 p-2 md:p-3 rounded-2xl">
                  <div className="relative rounded-xl overflow-hidden shadow-2xl">
                    ...
                    <img
                      src={feature.image}
                      alt={feature.title}
                      className="w-full h-[200px] sm:h-[260px] md:h-[360px] lg:h-[460px] object-cover transition-transform duration-500 group-hover:scale-110"
                    />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background via-background/60 to-transparent p-3 sm:p-4 md:p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20">
                      <p className="text-xs sm:text-sm lg:text-base text-foreground font-semibold flex items-center gap-2">

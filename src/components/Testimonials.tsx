  ...
  const testimonials = [
    {
      ...
      rating: 4.2,
      text: "RitzYard transformed our procurement process. We reduced material sourcing time by 70% and saved 15% on costs through their AI-powered supplier matching.",
      avatar: "RK",
      type: "builder",
    ...
    },
    {
      ...
      rating: 4,
      text: "RitzYard connected us with verified builders across South India. Our monthly orders tripled, and the logistics support is exceptional.",
      avatar: "SR",
      type: "vendor",

...
//                   <div>
//                     <h6 className="text-3xl md:text-3xl font-bold mb-2">
//   {product.name.split(" ").length > 20
...
//       <Sparkles className="w-6 h-6 text-[#ca5031]" />
//     </div>

//     <div>
//       <h4 className="font-bold mb-2 text-[#ca5031]">AI-Powered Procurement</h4>
...
//           </div>
//           <span>Instant multi-supplier quotes</span>
//         </li>
...
//             <Check className="w-4 h-4 text-white" />
//           </div>
//           <span>AI-driven price optimization</span>
//         </li>
    ...
    <div className="min-h-screen">
      ...
      <div className="section-padding relative z-10">
        <div className="container mx-auto px-4 mt-10">
          ...
          <div className="flex items-center gap-4 mb-8">
            <Link to="/products">
              <Button className="bg-gradient-to-br from-primary to-secondary text-primary-foreground">
                <ArrowLeft className="w-4 h-4 mr-2" />
                Back to Products
              </Button>
            </Link>
